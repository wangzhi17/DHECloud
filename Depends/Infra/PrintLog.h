...
struct PrintOptions
{
	...
	char thread;	//是否打印线程，0打印，1不打印，默认打印
	char version;	//是否打印版本，0打印，1不打印，默认打印
	char function;	//是否打印函数，0打印，1不打印，默认打印
	char file;		//是否打印文件名，0打印，1不打印，默认打印
	char line;		//是否打印行号，0打印，1不打印，默认打印
	char resv[23]; 	//保留
};
