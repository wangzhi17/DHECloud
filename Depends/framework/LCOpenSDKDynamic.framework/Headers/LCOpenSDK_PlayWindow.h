 ...
 *         -1, 接口调用失败
 */
- (NSInteger) playRtspReal:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk channel:(NSInteger)chn definition:(NSInteger)defiMode optimize:(BOOL)isOpt;
 ...
 *  @param deviceID  设备ID
 *  @param psk       设备密钥
 *  @param channelEx       通道ID
 *  @param defiMode  流媒体HD/SD模式
 *
 *  @return 0, 接口调用成功
 *         -1, 接口调用失败
 */
- (NSInteger) playRtspReal:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk channelEx:(NSString* )channelEx definition:(NSInteger)defiMode optimize:(BOOL)isOpt;
 ...
 *         -1, 接口调用失败
 */
- (NSInteger) playRtspReal:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk channel:(NSInteger)chn channelEx:(NSString* )channelEx definition:(NSInteger)defiMode optimize:(BOOL)isOpt;
 ...
 *         -1, 接口调用失败
 */
- (NSInteger) playDeviceRecord:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk channel:(NSInteger)chn fileName:(NSString*)fileName begin:(long)beginTime end:(long)endTime offsetTime:(double)offsetTime optimize:(BOOL)isOpt;
 ...
 *         -1, 接口调用失败
 */
- (NSInteger) playDeviceRecord:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk channelEx:(NSString* )channelEx fileName:(NSString*)fileName begin:(long)beginTime end:(long)endTime offsetTime:(double)offsetTime optimize:(BOOL)isOpt;
 ...
 *         -1, 接口调用失败
 */
- (NSInteger) playDeviceRecord:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk channel:(NSInteger)chn channelEx:(NSString* )channelEx fileName:(NSString*)fileName begin:(long)beginTime end:(long)endTime offsetTime:(double)offsetTime optimize:(BOOL)isOpt;

- (NSInteger) playDeviceRecordByFileName:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk fileName:(NSString*)fileName offsetTime:(double)offsetTime channel:(NSInteger)chn optimize:(BOOL)isOpt;

- (NSInteger) playDeviceRecordByUtcTime:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk channel:(NSInteger)chn begin:(long)beginTime end:(long)endTime optimize:(BOOL)isOpt;

- (NSInteger) playDeviceRecordByUtcTime:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk channelEx:(NSString* )channelEx begin:(long)beginTime end:(long)endTime optimize:(BOOL)isOpt;

- (NSInteger) playDeviceRecordByUtcTime:(NSString*)accessTok devID:(NSString*)deviceID psk:(NSString*)psk channel:(NSInteger)chn channelEx:(NSString* )channelEx begin:(long)beginTime end:(long)endTime optimize:(BOOL)isOpt;
 ...
 *         -1, 接口调用失败
 */
- (NSInteger)playCloud:(NSString*)accessTok devID:(NSString*)deviceID channelIDEx:(NSString* )channelIDEx begin:(long)beginTime end:(long)endTime psk:(NSString*)psk recordID:(NSString*)recordID offsetTime:(NSInteger)offsetTime Type:(NSInteger)type timeOut:(NSInteger)timeOut;
 ...
 *         -1, 接口调用失败
 */
- (NSInteger)playCloud:(NSString*)accessTok devID:(NSString*)deviceID channelID:(NSInteger)channelID channelIDEx:(NSString* )channelEx begin:(long)beginTime end:(long)endTime psk:(NSString*)psk recordID:(NSString*)recordID offsetTime:(NSInteger)offsetTime Type:(NSInteger)type timeOut:(NSInteger)timeOut;
 ...
 *         -1, 接口调用失败
 */
- (NSInteger)startRecordVideoOnly:(NSString*)filePath recordType:(NSInteger)nRecordType;
/**
 *  停止录制视频
 *
 *  @return 0, 接口调用成功
...
/**
*  改变播放参数，JSON串格式
*  @param jsonParams json格式的camera播放参数
*/
